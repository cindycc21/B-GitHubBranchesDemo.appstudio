...
const cacheName = 'A_GitHubBranchesDemo-2021-09-20 12:55:07.760439'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'A_GitHubBranchesDemo'.length) === 'A_GitHubBranchesDemo') {
